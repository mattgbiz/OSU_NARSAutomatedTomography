from tkinter import *
import XYZMotion_Station, SMC100Final, NewCameraControl#, CameraControl #Commented this out as we have the new file
...
class ManualControl:
    def __init__(self,root):
        ...
        self.RotationFrame = LabelFrame(root,text='Rotation Stage Control',padx=255,pady=2)
        ...
        self.CameraFrame.grid(row=0,column=0,padx=2)
        self.RotationFrame.grid(row=1,column=0,padx=2)
        self.XYZFrame.grid(row=2,column=0,padx=2)
        self.GeneralFrame.grid(row=3,column=0,padx=2)
