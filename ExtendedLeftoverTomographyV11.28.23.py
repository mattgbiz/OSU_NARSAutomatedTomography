...
class TomographyClass:
    def __init__(self,root):
        ...
        self.CameraOverallLabel.grid(row=2,column=0,columnspan=3)
        ...
        self.TestSMCButton.grid(row=6,column=2,sticky='w')
    ...
    def MMReady(self):
        ...
        self.MMReadyButton.grid(row=2,column=3,sticky='e')
        #This is a test
