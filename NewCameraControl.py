###
#If I ever get that closed is not an attribute or something similar
...
class CameraControl:
    ...
    def TakeImage(self,exposure,folder,filename,suffix,contrastVal,EMGain):
        ...
        #I am commenting all of this out as it seems to be a repeat
        #self.JPGImage = Image.open(filepath)
        #self.JPGImage.mode = 'I'
        #self.JPGImage.resize((100,100), Image.NEAREST) was already commented
        #self.JPGImage.point(lambda i:i*(1./256)).convert('L').save(JPGPath+'/'+filename+str(suffix)+'.jpeg')
...
#TakeImage(self,exposure,folder,filename,suffix,brightVal,contrastVal):
Attempt.TakeImage(15,'C:/Users/Public/NeutronImaging','Dark',5,40,40)
print('sleeping for 30 seconds')
time.sleep(10)
Attempt.TakeImage(15,'C:/Users/Public/NeutronImaging','Brightened',5,40,40)
#Attempt.CloseCamera()"""