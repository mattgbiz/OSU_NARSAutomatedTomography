...
class TomographyClass:
    def __init__(self,root):
        ...
        self.CameraPortLabel.grid(row=3,column=0)
        self.CameraPortEntry.grid(row=3,column=1)
        ...
        self.BrowseLabel.grid(row=4,columnspan=4)
        self.BrowseButton.grid(row=5,column=0,sticky='e')
        self.BrowseEntry.grid(row=5,column=1,columnspan=2,sticky='w')
        ...
        self.SubmitButton.grid(row=5,column=3,sticky='w')
        ...
        #self.MMLocationLabel = Label(self.InitializeTomographyFrame,text='MM Executable Location:')
        #self.MMLocationEntry = Entry(self.InitializeTomographyFrame,width=50)
        #self.MMLocationEntry.insert(0,'C:/Program Files/Micro-Manager-2.0gamma/ImageJ.exe')
        #self.OpenMMButton = Button(self.InitializeTomographyFrame,text='Open MM',command=self.OpenMM)
        ...
        #self.MMLocationLabel.grid(row=1,column=0,sticky='w')
        #self.MMLocationEntry.grid(row=1,column=2,sticky='e')
        #self.OpenMMButton.grid(row=2,column=0,sticky='w')
        ...
        #toss these on the screen
        #self.ImageTextLabel.grid(row=0,column=0)
        #self.BrightEntry.grid(row=0,column=1)
