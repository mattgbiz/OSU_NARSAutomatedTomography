...
class TomographyClass:
    def __init__(self,root):
        ...
        self.RotationLabel.grid(row=3,column=0)
        self.RotationEntry.grid(row=3,column=1)
        self.SMCPortLabel.grid(row=3,column=2)
        self.SMCPortEntry.grid(row=3,column=3)
        self.StartDegreeLabel.grid(row=4,column=0)
        self.StartDegreeEntry.grid(row=4,column=1)
        self.CameraPortLabel.grid(row=4,column=2)
        self.CameraPortEntry.grid(row=4,column=3)
        self.MaxDegreeLabel.grid(row=5,column=0)
        self.MaxDegreeEntry.grid(row=5,column=1)
        self.FewViewCheck.grid(row=5,column=2)
    ...
    def Submit(self):
        ...
        #if we have 360 as the max degree, remove it since we don't need both 0 and 360
    ...
    def ControlPeripherals(self):
        ...
        for deg in self.DegreeList:
            ...
            try:
                ...
                self.Image=self.Camera.TakeImage(self.ExposureTime,self.FileLocation,self.FileName,str(self.suffix),self.ContrastRun,self.EMGain)
                ...
                self.ContrastPath = self.FileLocation+'/ReSizedJPGs/'+self.FileName+str(self.suffix)+'_contrast'+'.jpeg'
                self.ContrastTiff = self.FileLocation+'/ReSizedJPGs/'+self.FileName+str(self.suffix)+'_contrast.tif'
                self.JPGPath = self.FileLocation+'/ReSizedJPGs/'+self.FileName+str(self.suffix)+'.jpeg'
